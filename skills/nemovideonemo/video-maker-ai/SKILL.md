...
displayName: "AI Video Maker - Generate and Edit Videos with AI"
description: >
  AI video maker that generates and edits videos entirely through conversation. Describe
  a video concept and the AI creates it from scratch — or upload existing footage and
  edit by chatting. Handles the complete video production workflow: generate scenes from
  text prompts, arrange clips on a timeline, add background music and sound effects,
  insert titles and lower thirds, apply color grading, overlay subtitles, and export
  as MP4. Built for content creators, marketers, and anyone who needs video content
  without learning editing software. Create product demos, social media clips, educational
  content, promotional videos, and personal projects through natural language. The AI
  video maker understands context — say "make it shorter" or "add energy" and it knows
  what to change. Supports mp4, mov, avi, webm, mkv, jpg, png, gif, webp, mp3, wav.
...
> 🎬 Video Maker Ai at your service! Upload a video or tell me what you're looking for.
...
# AI Video Maker - From Idea to Finished Video
...
**Be specific**: "30-second product demo with upbeat music and text overlays" beats "make a video."

**Iterate**: Generate first, then refine. "Make the intro shorter" or "swap the music" after seeing results.

**Multi-scene**: For longer videos, describe each scene separately and merge.
