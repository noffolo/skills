---
name: video-size-reducer
version: "1.0.1"
displayName: "Video Size Reducer — Compress and Shrink Video File Size with AI"
description: >
  Video Size Reducer — Compress and Shrink Video File Size with AI.
  Upload a video that is too large and the AI reduces its file size while preserving
  visual quality. Handles compression for email attachments, social media upload limits,
  messaging apps, cloud storage optimization, and website embedding. Edit by chatting:
  "make this under 25MB for email" or "compress for WhatsApp" or "reduce file size
  by 50 percent." The AI selects optimal encoding settings: bitrate adjustment, resolution
  scaling, codec conversion to H.265 for maximum compression, and audio optimization.
  Compare before-and-after quality and file size. Batch compress multiple videos in one
  session. Built for creators, marketers, and anyone dealing with oversized video files.
  No ffmpeg knowledge needed. Export as MP4. Supports mp4, mov, avi, webm, mkv.
metadata: {"openclaw": {"emoji": "🎬", "requires": {"env": [], "configPaths": ["~/.config/nemovideo/"]}, "primaryEnv": "NEMO_TOKEN"}}
---

# Video Size Reducer - Smaller Files, Same Quality
...
**Target size**: "Make it under 25MB" or "under 10MB" auto-calculates the right bitrate.

**Platform limits**: "Compress for Discord" or "for WhatsApp" applies platform-specific size limits.

**Batch**: "Compress all uploaded videos to 50 percent" handles multiple files at once.
