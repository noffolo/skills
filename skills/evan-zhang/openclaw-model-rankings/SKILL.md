...
description: 本地化 OpenRouter 模型目录与问答筛选 Skill。用于“模型选型/价格对比/上下文能力筛选/工具调用能力筛选/低延迟排序/A vs B 对比”等问题；触发词包括：模型推荐、模型排行、预算选型、最便宜模型、支持 tool_use、支持 function calling、支持 JSON mode、128k 上下文、模型延迟、模型对比。
---
