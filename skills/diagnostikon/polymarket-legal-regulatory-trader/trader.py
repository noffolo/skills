...
KEYWORDS = ['Supreme Court', 'lawsuit', 'antitrust', 'SEC', 'DOJ', 'EU fine', 'GDPR', 'regulation', 'court ruling', 'verdict', 'Apple', 'Google', 'Meta', 'Microsoft', 'Amazon', 'FTC', 'merger', 'acquisition blocked', 'appeal', 'settlement', 'class action', 'patent', 'trial', 'Binance', 'Coinbase', 'crypto regulation', 'CFTC']
